...
Ver.1.13  2026/05/21
                     プラグインSTF追加
                     プラグインTwentyOne.x追加(AUTOEXEC.BAT組込)
Ver.1.14  2026/05/30
                     プラグインMCDRV,MCDISP関係追加
                     プラグイン確認をプラグインリストビューアに更新
                     7-zipで展開エラーを続行することにした。(暫定MCDRV068.lzh対策)
                     メニューに以前の「EZX6 plugins 確認」が残るので必要に応じて削除してください。
                     起動時にxm6g.exe,XM6Util.exe起動チェックして起動していたら中止するようにした。
==================================================================
```
